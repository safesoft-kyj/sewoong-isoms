...
import com.dtnsm.common.config.ClassPathTldsLoader;
import com.dtnsm.common.security.authentication.CustomAuthenticationProvider;
import com.dtnsm.common.security.authentication.CustomWebAuthenticationDetailsSource;
import com.dtnsm.common.security.filter.AjaxRequestHandlingFilter;
import com.dtnsm.common.security.vote.CustomWebAccessDecisionVoter;
import com.dtnsm.common.service.CustomUserDetailsService;
import com.dtnsm.esop.security.CustomAccessDeniedHandler;
...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/admin/**").hasAnyAuthority(adminRole1, adminRole2, adminRole3, adminRole4)
