...
import com.cauh.common.entity.JobDescriptionVersion;
import com.cauh.common.repository.JobDescriptionRepository;
import com.cauh.common.repository.JobDescriptionVersionRepository;
...
//    private final DeptUserMapper deptUserMapper;
    ...
    public void run(ApplicationArguments args) {
        ...
        if("dev".equals(activeProfile)) {
            //DEV 환경에서 시작 시, 초기 세팅
            //addUser(1, "admin", "admin", "관리자", "Administrator", true, "AD001");
        }
