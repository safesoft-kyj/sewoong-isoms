package com.cauh.esop.validator;
...
import com.cauh.esop.service.DocumentService;
import com.cauh.esop.utils.NumberUtils;
                    ...
                    if(StringUtils.isEmpty(sop.getDocId())) {
                        ...
                        if(!sop.getDocId().startsWith("SOP-")) {
                            ...
                            if(categoryAndNo.length() < 6) {
                                ...
                                if(!com.cauh.esop.utils.StringUtils.isAlphabetOnly(categoryId)) {
