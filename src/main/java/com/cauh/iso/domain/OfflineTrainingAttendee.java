...
@NoArgsConstructor
@Entity
@Table(name = "s_offline_training_attendee", uniqueConstraints = {@UniqueConstraint(columnNames = {"offline_training_id", "account_id"})})
@Slf4j
@ToString(of = {"id"})
...
public class OfflineTrainingAttendee extends BaseEntity implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "OFF_TRAINING_ATTENDEE_SEQ_GENERATOR")
    private Integer id;
