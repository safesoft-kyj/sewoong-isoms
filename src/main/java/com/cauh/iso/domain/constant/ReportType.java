...
public enum ReportType {
    ...
    SOP_RF_Request_Form("SOP/RF Request Form", "sop_rf_requestForm", "app_sop_rf_request_form"),
//    RD_Approval_Form("RD Approval Form", "rd_approvalForm"),
    SOP_RF_Retirement_Form("SOP/RF Retirement Form", "sop_rf_retirementForm", "app_sop_rf_retirement_form"),
