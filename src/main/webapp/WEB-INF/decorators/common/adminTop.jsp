...
<%--                        <ul class="head-list">--%>
<%--                            <li>--%>
<%--                                <a href="#"><i class="pli-male icon-lg icon-fw"></i> 개인정보</a>--%>
<%--                            </li>--%>
                            <%--                            <li>--%>
                            <%--                                <a href="#"><span class="badge badge-danger pull-right">9</span><i class="pli-mail icon-lg icon-fw"></i>--%>
                            <%--                                    Messages</a>--%>
                            <%--                            </li>--%>
                            <%--                            <li>--%>
                            <%--                                <a href="#"><span class="label label-success pull-right">New</span><i class="pli-gear icon-lg icon-fw"></i>--%>
                            <%--                                    Settings</a>--%>
                            <%--                            </li>--%>
                            <%--                            <li>--%>
                            ...
                            <%--                            </li>--%>
<%--                            <li>--%>
<%--                                <a href="/"><i class="fa fa-sign-out icon-lg icon-fw"></i> 관리자 나가기</a>--%>
<%--                            </li>--%>
<%--                        </ul>--%>
<%--                    </div>--%>
                </li>
